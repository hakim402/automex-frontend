          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {industries.map((industry) => {
              ...
              const imageUrl = industry.icon_image?.url
                ...
                : null;
              const safeCompliance = Array.isArray(
              ...
              return (
                ...
                >
                  ...
                  {imageUrl ? (
                    <div className="flex size-14 items-center justify-center rounded-xl bg-brand-gradient/5 overflow-hidden">
                  ...
                  <div className="flex-1">
                    ...
                    {safeCompliance.length > 0 && (
                      <div className="flex flex-wrap items-center gap-1.5 mt-3">
                        <ShieldCheck
                          className="size-3 text-green-500/70 shrink-0"
                          aria-hidden="true"
                        />
                        {safeCompliance.slice(0, 3).map((std) => (
                          <span
                            key={std}
                            className="inline-block rounded-full border border-green-500/20 bg-green-500/5 px-2 py-0.5 text-[10px] font-medium text-green-600/80"
                          >
                            {std}
                          </span>
                        ))}
