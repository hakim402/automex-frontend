...
export function PortfolioClientPage({
  ...
  // Industry and technology filter helpers
  const handleIndustrySelect = (value: string | undefined) => {
    navigateTo(getFilterParams({ industry: value }));
  };

  const handleTechnologySelect = (value: string | undefined) => {
    navigateTo(getFilterParams({ technology: value }));
  };
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-5 gap-2">
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground mt-2 pt-2 border-t border-border/20">
                      {proj.client_name && (
                        <span className="font-medium text-foreground/80 truncate max-w-30">
                          {proj.client_name}
                        </span>
                      )}
