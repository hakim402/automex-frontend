...
export function BudgetTimelineFields<T extends FieldValues>({
  control,
  errors,
}: Props<T>) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <CrmFormField
        id="budget_range"
        label={t("budgetLabel")}
        error={errors[budgetName]?.message as string | undefined}
      >
        <Controller
          name={budgetName}
          control={control}
      ...
      <CrmFormField
        ...
        error={errors[timelineName]?.message as string | undefined}
      >
        <Controller
          name={timelineName}
          control={control}
