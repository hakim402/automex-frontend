...
import type {
  ...
  TechTool,
  TechCategory,
} from "@/components/shared/TechStack";
...
const TOOLS: TechTool[] = [
  // AI & LLMs
  {
    ...
    color: "#10a37f",
    logo: OpenAILogo,
    description: "GPT-4o, Assistants API, embeddings",
  },
  {
    name: "Anthropic",
    category: "AI",
    color: "#c96442",
    logo: AnthropicLogo,
    description: "Claude 3.5 for reasoning & analysis",
  },
  {
    name: "Make.com",
    category: "AI",
  ...
  },
  {
    ...
    color: "#ff4a00",
    logo: ZapierLogo,
    description: "No-code AI task automation",
  },
  ...
  },
  {
    ...
    color: "#0052cc",
    logo: JiraLogo,
    description: "Issue tracking & agile sprints",
  },
  {
    name: "Linear",
    category: "Productivity",
    color: "#5e6ad2",
    logo: LinearLogo,
    description: "Modern issue & project tracker",
  },
  {
    name: "Figma",
    category: "Productivity",
  ...
  // Cloud & Infra
  {
    ...
    color: "#ff9900",
    logo: AWSLogo,
    description: "Compute, S3, Lambda, RDS",
  },
  {
    name: "Google Cloud",
    category: "Cloud",
    color: "#4285f4",
    logo: GCPLogo,
    description: "GKE, BigQuery, Vertex AI",
  },
  {
    name: "Azure",
    category: "Cloud",
  ...
  },
  {
    ...
    color: "#000000",
    logo: VercelLogo,
    description: "Frontend deployment & edge",
  },
  {
    name: "Supabase",
    category: "Cloud",
  ...
  // Communication
  {
    ...
    color: "#4a154b",
    logo: SlackLogo,
    description: "Team messaging & bot integration",
  },
  {
    name: "WhatsApp",
    category: "Communication",
  ...
  },
  {
    ...
    color: "#2ca5e0",
    logo: TelegramLogo,
    description: "Bot API & channel automation",
  },
  {
    name: "Zoom",
    category: "Communication",
